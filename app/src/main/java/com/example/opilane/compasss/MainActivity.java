package com.example.opilane.compasss;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        //süsteemi orientatsioon sensor, registeerib muudatusi
    ...
    protected void onResume() {
        super.onPause();
        //lõptame registeeringute kuulamise
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        //kuvame oma textviewids toimunud kraadi muudatuse
        suund.setText("Suund: "+ Float.toString(kraadinurk)+"kraadi");
        //loome pöörlemis animatsiooni
        RotateAnimation pöörlemisAnimatsioon = new RotateAnimation(alguseKraadid, -kraadinurk, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
